...
public extension Package {
  ...
  static let Facebook = Package.remote(url: "https://github.com/facebook/facebook-ios-sdk", requirement: .upToNextMajor(from: "14.1.0"))
}
...
public extension TargetDependency.SPM {
  ...
  static let Facebook = TargetDependency.package(product: "Facebook")
}
